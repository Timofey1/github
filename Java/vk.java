...
public class vk implements Parser{
    ...
    public static List<Post> parse(String vkgroupid) throws IOException {
        ...
        String url = String.format("https://api.vk.com/method/wall.get?owner_id=-%s&access_token=02585fa1b7e0b4296c1ef207d1410e8030a041b99f0c38d44cc3f84f786bde10261e38565b8f374564164&v=V", vkgroupid);
        String html = Jsoup.connect(url).ignoreContentType(true).get().text();
